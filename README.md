...
| カテゴリ | 技術 |
|----------|------|
| プログラミング言語 | TypeScript, PHP, Java ※C, C#は少しだけわかります |
...
技術的な意思決定や、環境の整備を通して、開発フローの改善を行うことに熱心に取り組み、設計からリリースまで一貫して担当できることが強みです。技術的な意思決定においては、チームの習熟度、コミュニティの活発さ、メンテナンス性を重視し、小さなPoCで検証してから提案を行います。

### 今後のキャリア方向性

技術力を深めつつ、設計や技術方針に関わるリードエンジニアを目指しています。また、チームビルディングなど技術に直結しない開発に関わる面についての理解を深め、様々なプロジェクトに触れながら、思考を広げていきたいと考えています。
